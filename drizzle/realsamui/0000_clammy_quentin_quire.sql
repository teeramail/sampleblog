...
CREATE TABLE "post" (
	...
	"isQuestion" boolean DEFAULT true NOT NULL,
	"authorName" varchar(256)
);
--> statement-breakpoint
ALTER TABLE "answer" ADD CONSTRAINT "answer_postId_post_id_fk" FOREIGN KEY ("postId") REFERENCES "public"."post"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "answer_post_id_idx" ON "answer" USING btree ("postId");--> statement-breakpoint
CREATE INDEX "answer_created_at_idx" ON "answer" USING btree ("createdAt");--> statement-breakpoint
